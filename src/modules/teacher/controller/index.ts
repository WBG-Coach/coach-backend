...
export default class TeacherController {
  public static create = async (req: Request, res: Response): Promise<any> => {
    try {
      const newItem = await TeacherService.create(req.body);
  ...
  public static delete = async (req: Request, res: Response): Promise<any> => {
    try {
      const deletedItem = await TeacherService.delete(req.params.id);
  ...
  public static update = async (req: Request, res: Response): Promise<any> => {
    try {
      const updatedItem = await TeacherService.update(req.body.id, req.body);
  ...
  public static findAll = async (
    ...
    try {
      const list = await TeacherService.findAll();
  ...
  public static findById = async (
    ...
    try {
      const item = await TeacherService.findByID(req.params.id);
